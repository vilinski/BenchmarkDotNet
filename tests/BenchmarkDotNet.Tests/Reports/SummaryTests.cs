...
namespace BenchmarkDotNet.Tests.Reports
{
    public class SummaryTests
    {
        ...
        private static Summary CreateSummary(IList<BenchmarkReport> reports)
        {
            ...
            return new Summary("MockSummary", reports.ToImmutableArray(), hostEnvironmentInfo, string.Empty, string.Empty, TimeSpan.FromMinutes(1.0), FormatStyle.DefaultStyle, ImmutableArray<ValidationError>.Empty);
        }
